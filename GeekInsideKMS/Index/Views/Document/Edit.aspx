    ...
    <form action="/Document/doEdit" method="post" name="docdetail" id="docdetail">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
        	<tr style="height:50px;">
                ...
                标题：</td>
                <td><input type="text" name="title" value="<%:docModel.FileDisplayName %>"/>.<%:docModel.FileTypeName %>
            ...
            <tr style="height:50px;">
                <td><input type="button" class="button" value="提交修改"  onclick="javascript:document.forms[1].submit();"></td>
                <td><td>
            </tr>
        </table>
    </form>
