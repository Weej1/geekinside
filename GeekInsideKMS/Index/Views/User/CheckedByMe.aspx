        ...
        <div id="content">
            <div id="workdesk-content">
                <div id="deskDocsList">
                    ...
                    <% } %>
                    <p class="discreet">
                        下面是您审核通过的文档列表（点击标题可查看文档内容）：</p>
                    <% if (ViewData["docList"].Equals("nodata")) { %>
                        <p style="color:red;">暂无您审核过的文档</p>
                    <%}else{%>
                            ...
                            <div class="itemInfo">
                                <h1>
                                    ...
                                    <span class="docListOperation">
                                        <a href="/Document/doUnCheck?docid=<%: doc.Id %>&returnURL=CheckedByMe">设置为未通过</a>
                                        <a href="/Document/Delete?docid=<%: doc.Id %>&returnURL=CheckedByMe">直接删除</a>
                                    </span>
                                </h1>
